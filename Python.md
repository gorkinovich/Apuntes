...
$$\mathit{real} \textcolor{red}{\char123} \texttt{j} \textcolor{red}{|} \texttt{J} \textcolor{red}{\char125}$$

Basta con indicar un número real y terminar con una `j` para representar los números imaginarios en Python. Luego con la función `complex(R,I)`, donde `R` es la parte real e `I` la imaginaria, podremos componer números complejos.
