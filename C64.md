...
Una vez calculadas todas las frecuencias de las notas, la cosa no se queda ahí para el chip SID, ya que la frecuencia es representada como un valor entero sin signo de 16 bits. Para convertir, una frecuencia a valores admitidos por los registros del chip, usaremos la siguiente fórmula:
