...
$$
\texttt{DIM}\ \mathit{variable}\texttt{(}\mathit{n_1}\textcolor{red}{[},\mathit{n_2}\textcolor{red}{[},\ldots\textcolor{red}{]}\textcolor{red}{]}\texttt{)}\textcolor{red}{[},\ldots\textcolor{red}{]}
$$
...
```
ABS ASC ATN CHR$ CLOSE CLR CMD CONT COS DATA DEF END EXP FN FOR FRE GET GET# GOSUB GOTO IF INPUT INPUT# INT LEFT$ LEN LOAD LOG MID$ NEW NEXT ON OPEN PEEK POKE POS PRINT PRINT# READ RESTORE RETURN RIGHT$ RND RUN SAVE SGN SIN SPC SQR STATUS STEP STOP STR$ SYS TAB TAN THEN TIME TIME$ TO USR VAL VERIFY WAIT
```
