...
* **Enteros:** Números con signo de 16 bits (2 Bytes). Desde `-32768` hasta `+32767`, usando la siguiente sintaxis:

$$\textcolor{red}{[}\texttt{+}\textcolor{red}{|}\texttt{-}\textcolor{red}{]} \mathit{d\acute{\imath}gitos}$$ 

* **Flotantes:** Números flotantes con signo de 40 bits (5 Bytes). El exponente puede tener un valor desde `-39` hasta `+38`. Usan la siguiente sintaxis:
