...
| **4** | `9` | `I` | `J` | `0` | `M` | `K` | `O` | `N` |
| **5** | `+` | `P` | `L` | `-` | `.` | `:` | `@` | `,` |
| **6** | `£` | `*` | `;` | `CLR/HOME` | `SHIFT` (De.)<br/>`SHIFT LOCK` | `=` | `↑` | `/` |
| **7** | `1` | `←` | `CTRL` | `2` | `SPACE` | `C=` | `Q` | `RUN/STOP` |

Las filas son los bits que podemos escribir en `$DC00` y las columnas los bits que podemos leer en `$DC01`.
